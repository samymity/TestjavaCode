 ...
 * "org.example.demo" })
 *
 * @EnableTransactionManagement public class H2JpaConfig {
 *
 ...
 * dataSource.setUrl("jdbc:h2:~/test1"); dataSource.setUsername("sa");
 ...
 * em.setPackagesToScan(new String[] { "org.example.demo",
 * "org.example.demo.config", "org.example.demo.config",
 * "org.example.demo.entity" }); em.setJpaVendorAdapter(new
 * HibernateJpaVendorAdapter()); em.setJpaProperties(additionalProperties());
 * return em; }
 *
 * @Bean JpaTransactionManager transactionManager(final EntityManagerFactory
